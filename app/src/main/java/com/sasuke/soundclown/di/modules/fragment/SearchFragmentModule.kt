...
import com.sasuke.soundclown.ui.search.SearchCategoryAdapter
import com.sasuke.soundclown.ui.search.SearchFragmentViewModel
...
abstract class SearchFragmentModule {
    ...
    companion object {
        @Provides
        @PerFragmentScope
        fun adapter(glide: RequestManager): SearchCategoryAdapter {
            return SearchCategoryAdapter(glide)
        }
